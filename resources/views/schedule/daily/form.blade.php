    ...
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header text-white  bg-danger" >
                            <h4 class="modal-title" id="myModalLabel">Option Change <i class="fa fa-user-plus"></i></h4>
				        </div>
              <form  id="optionForm" class="form-horizontal">
                <div class="modal-body">       
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                        <label for="sel1">Select Option:</label>
                                <select class="form-control js-example-basic-single" id="option">
                ...
                <div class="modal-footer">
                  <div class="col-sm-12 text-center">
                      <button type="button"  class="btn btn-danger cancel_data" data-dismiss="modal">Cancelar</button>
					            <button type="submit" class="btn btn-success" id="btn-saveO" value="update">Guardar</button>
                  </div>
                </div>
            </form> 
            <input type="hidden" id="shcedule_idO" name="shcedule_idO" value="0"> 
            </div>
          </div>
        </div>